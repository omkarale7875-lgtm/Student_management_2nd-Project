...
class Register:
    def __init__(self, root):
        ...
        try:
            ...
            bg = Label(self.root, bg="#021e2f").place(x=250, y=0, relwidth=1, relheight=1)
        ...
        try:
            ...
            left = Label(self.root, bg="#08A3D2").place(x=80, y=80, width=400, height=500)
        ...
        try:
            ...
            btn_register = Button(frame1, text="Register", font=("times new roman", 18, "bold"), bg="green", fg="white", cursor="hand2", command=self.register_data).place(x=50, y=420, width=180, height=40)
