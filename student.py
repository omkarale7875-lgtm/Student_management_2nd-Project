...
class studentClass:
    def __init__(self, root):
        ...
        btn_search = Button(self.root, text="Search", font=("goudy old style", 15, "bold"), bg="#2196f3", fg="white", cursor="hand2", command=self.search).place(x=1040, y=60, width=110, height=28)

        #  Student Details Treeview 
